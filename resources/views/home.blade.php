        ...
        <div class="overflow-hidden relative md:h-full xl:h-full 2xl:h-ful text-black">
            ...
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <div class="absolute inset-x-[15%] bottom-96  py-5 text-center text-black md:block">
                    <h1 class="text-4xl font-bold">Consumibles de calidad para tu empresa</h1>
                </div>
            </div>
            <!-- Item 2 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{asset('img/zt2.jpg')}}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2">
                <div class="absolute inset-x-[15%] bottom-96  py-5 text-center text-black md:block">
                    <h1 class="text-4xl font-bold">Mejoramos la eficiencia operativa</h1>
                </div>
            </div>
            <!-- Item 3 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{asset('img/almacen2.avif')}}" class="block absolute top-1/2 left-1/2 w-full -translate-x-1/2 -translate-y-1/2">
                <div class="absolute inset-x-[15%] bottom-96  py-5 text-center text-black md:block">
                    <h1 class="text-4xl font-bold">Somos distribuidores autorizados</h1>
                </div>
            </div>
            <!-- Item 4 -->
            <div class="hidden duration-700 ease-in-out" data-carousel-item>
                <img src="{{asset('img/zt411_uso.png')}}" class="absolute block w-full -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2">
                <div class="absolute inset-x-[15%] bottom-96  py-5 text-center text-black md:block">
                    <h1 class="text-4xl font-bold">Soporte 100% garantizado</h1>
                </div>
            </div>
        </div>
        <!-- Slider indicators -->
...
<div>
        ...
        <hr class="">
        <!-- Start Mensaje-->
        <div class="w-full m-auto b-32 flex sm:h-2/5 xl:h-1/5" style="background-image: url({{asset('img/fondohome2.jpg')}})">
            <p class="text-center m-auto font-serif w-3/4 text-white" >Podemos conseguir cualquier producto que necesites para tu pequeña,mediana o grande empresa,damos soluciones tecnologicas de calidad.</p>
        </div>
        <!-- End Mensaje-->
        <h1 class="">
        <!-- Start Rama de Conocimiento -->
        <div class="w-full m-auto b-32  flex flex-col">
